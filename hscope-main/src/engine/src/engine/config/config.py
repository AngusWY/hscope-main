...
DEFAULT_WORKSPACE                                            = "engine_workspace"
...
SRC_ENGINE_DIR                                                 = os.path.join(ROOT_DIR, "src/engine")
EXTERNS_MOCK_CODE_DIR                                        = os.path.join(SRC_ENGINE_DIR, "externs/mock")
EXTERN_RULES_DIR                                             = os.path.join(SRC_ENGINE_DIR, "externs/rules")
EXTERN_MODEL_CODE_DIR                                        = os.path.join(SRC_ENGINE_DIR, "externs/modeling")
