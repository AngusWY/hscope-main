...
class Parser(common_parser.Parser):
    def init(self):
        ...
        self.CONSTANTS_MAP = {
            ...
            "undef"                             : ENGINE_INTERNAL.UNDEFINED,
    ...
    def global_global(self, node: Node, statements: list):
        ...
        attrs = []
        if "[" in shadow_type:
            attrs.append(ENGINE_INTERNAL.ARRAY)
        if "*" in shadow_type:
            attrs.append(ENGINE_INTERNAL.POINTER)
    ...
    def struct_value(self, node, statements):
        ...
        self.append_stmts(statements, node, {"new_object": {"target": struct_name, "data_type": ENGINE_INTERNAL.UNDEFINED}})
    ...
    def array_value(self, node, statements):
        ...
        self.append_stmts(statements, node, {"new_array": {"target": array_name, "data_type": ENGINE_INTERNAL.UNDEFINED}})
    ...
    def cmp_stmt(self, node: Node, statements: list):
        ...
        if operator in self.CONSTANTS_MAP:
            ...
            if operator == "false":
                return ENGINE_INTERNAL.FALSE
            if operator == "true":
                return ENGINE_INTERNAL.TRUE
            if operator == "nrd":
                pass
            if operator == "uno":
                pass
