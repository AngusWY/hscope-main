...
class TypeHierarchy:
    ...
    def analyze_method_in_class(self, class_decl_stmt, scope_hierarchy):
        method_decls = scope_hierarchy.query(
            ...
            ((scope_hierarchy.scope_kind == ENGINE_SYMBOL_KIND.METHOD_KIND)|(scope_hierarchy.scope_kind == ENGINE_SYMBOL_KIND.CLASS_KIND))
        )
        all_method_info = []
    ...
    def analyze_type_hierarchy(self, unit_id):
        ...
        # obtain class decls
        class_decl_stmts = scope_hierarchy.query(scope_hierarchy.scope_kind == ENGINE_SYMBOL_KIND.CLASS_KIND)
