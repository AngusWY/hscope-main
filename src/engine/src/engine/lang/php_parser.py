...
class Parser(common_parser.Parser):
    ...
    def assignment_expression(self, node: Node, statements: list):
        ...
        # TODO dynamic_variable_name,${x} = 10,
        # 
    ...
    def function_declaration(self, node: Node, statements: list):
        ...
        # bodyanonymous_function_use_clausebody
        gir_node["body"] = []
    ...
    def formal_parameters(self, node: Node, statements: list):
        for parameter in node.named_children:
            ...
            if parameter.type == "variadic_parameter":   # (...arg)
    ...
    def enum_body(self, node, gir_node, type, statements):
        ...
        if class_init:
            methods_body.insert(0, {"method_decl":{"name": ENGINE_INTERNAL.CLASS_INIT, "body": class_init}})
        if class_static_init:
            methods_body.insert(0, {"method_decl":{"name": ENGINE_INTERNAL.CLASS_STATIC_INIT, "body": class_init}})
